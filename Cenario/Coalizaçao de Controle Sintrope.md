...
A **Coalização de Controle Sintrope (CCS)** foi formalmente estabelecida no ano de **1910**, como resposta direta ao aumento exponencial de incidentes relacionados aos chamados _Fenômenos Sintropes Ativos_.

Sua fundação foi dada pela necessidade da organização regional de países na Asia e Europa — Sul da china, Balcãs, Ira, Paquistão — para enfrentar monstros e fenômenos sintropes que traziam flagelo para a população local. Dessa forma, em 02/09/1897 foi feito o *tratado de contenção de fenômenos sintropes do sul asiático* entre os países do Sião, índia, china (parcialmente) e Filipinas. Esse tratado inicial tinha como base o compartilhamento de inteligência, recursos e mão de obra para lidar com criaturas magias e conter efeito de desastres naturais.

Dado o sucesso parcial do tratado, outros 45 países e Companhias se juntaram a um novo tratado similar firmado em 1900 em Warsaw na Rússia. Marcando assim o inicio de uma visão mais globalizada da contenção de efeitos sintropes.
...
Devido a uma nova explosão de eventos sintropes ativos no continente europeu, em 1910 a França propôs a criação de uma organização internacional de contenção ativa, com forças tarefa de diversos paises sendo atribuídas a diversas operações através de informações compartilhadas entre os paises
...
**2. Contenção Ativa**  
Captura, neutralização ou isolamento de entidades e fenômenos considerados perigosos à estabilidade civil e política.
...
A Coalizão é dividida em três grandes braços operacionais:

- **Divisão de Vigilância**  
    Responsável por inteligência, espionagem e monitoramento de atividades sintropes e organizações paralelas.
- **Divisão de Contenção**  
    Unidades especializadas em captura de entidades, resposta a crises e operações de campo de alto risco.
- **Divisão de Pesquisa e Redistribuição**  
...
Paralelamente temos o **Diretor-Geral de Assuntos internos**, responsável pela administração ,investigação e apoio de recursos humanos dentro da organização. Esse cargo, representa também uma posição de poder e influencia, porem sua natureza garante analise de mais documentos, e menos capacidade de exercer a influencia fora da organização.
