...
actions:
  - name: Garras
    ...
    attack_bonus: 0
  - name: Estraçalhar
    desc: Custa duas ações, O ghoul tenta [[Imobilizado|imobilizar]] um alvo (Disputa de força bruta) com sucesso, ele usa suas duas garras para estraçalhar o alvo, causando `dice:2d10+5` de dano
    attack_bonus: 0
  - name: Partir
    desc: Apos acertar duas Garras, o ghoul pode utilizar as garras cravadas para causar grandes danos internos no inimigo, causando `dice:2d10` de dano, e [[Sangrando|sangramento]]
    attack_bonus: 0
legendary:
  - name: Grito estridente
    desc: O ghoul emite um grito terrivel utilizando orgaos parecidos com guelras localizados no pescoço para vibrar som e mana ao redor, atordoano criaturas proximas. Ao utilizar essa habilidade todas as criaturas em um raio de 30 metros tem de realizar um teste de postura DT 10 ou perdem uma açao no proximo turno.
  - name: Fuga
