...
| Nivel | Característica                                    | Contratos disponíveis | Magias conhecidas | Dons das entidades |
| ----- | ------------------------------------------------- | --------------------- | ----------------- | ------------------ |
...
| Don                                                                                                                                                                                                                                                                                                                  | Don                                                                                                                                                                                                                                                                                                                               |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Coração Incandescente**<br>Seu corpo pulsa com calor arcano.<br><br>- Recebe **resistência a dano ígneo**<br>- Sempre que causa dano com magia:<br>    - causa **+1 dano ígneo adicional**<br><br>Se o alvo estiver **marcado**:<br><br>- esse bônus se torna **+1d4**                                             | **Corpo em Combustão**<br><br>Você transforma dor em destruição.<br><br>- Sempre que sofre dano:<br>    - pode usar uma reação para:<br>        - causar **1d4 dano ígneo** no agressor<br><br>Se estiver com menos de 50% de vida:<br><br>- o dano aumenta para **1d6**d4**                                                      |
| **Sussurros da Brasa**<br><br>Ignivar fala com você… o tempo todo.<br><br>- +2 em testes para:<br>    - perceber perigo<br>    - detectar intenções hostis<br>- −2 em testes para resistir a impulsos destrutivos<br><br>Uma vez por cena:<br><br>- pode pedir ao mestre um “pressentimento” sobre conflito iminente | **Sussurros da Brasa**<br><br>Ignivar fala com você… o tempo todo.<br><br>- +2 em testes para:<br>    - perceber perigo<br>    - detectar intenções hostis<br>- −2 em testes para resistir a impulsos destrutivos<br><br>Uma vez por cena:<br><br>- pode pedir ao mestre um “pressentimento” sobre conflito iminente              |
...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| **Magias:**  <br>[[Lamina Umbral]]<br>[[Passos nebulosos]]       | **Predador Invisível**  <br>Ataques contra inimigos desprevenidos recebem:<br><br>- +2 Vantagem para acerto<br>- +1 Dado de dano | **Dissolução Sombria**  <br>_Reação_<br>*2PM*<br><br>Ao ser alvo de ataque:<br><br>- Move 3m para um local com sombra |
...
| **Nivel 1**                                                                                                                                                                                                                                                                                                                                                                         | **Nivel 2**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | **Nivel 3**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| *Magias*<br>[Pulso sintrope](app://obsidian.md/Pulso%20sintrope)  <br>[Mutaçao efemera](app://obsidian.md/Muta%C3%A7ao%20efemera)                                                                                                                                                                                                                                                   | **Infecção instrumentalizada**<br>*Reação – 3PM – Uma vez por turno*<br>Ao causar dano corpo a corpo ou com *Pulso sintrope* durante o turno do conjurador  pode consumir cargas de *Corrupção biologia* para:<br>*1 carga* → +1d4 dano necrótico e aplica Infecção  <br>*2 cargas* → +1 dado de dano adicional e -2 Defesa por 1d4 turnos (se já infectado)  <br>*3 cargas* → +1 dado de dano adicional e aplica Infecção severa  <br>*4 cargas* → +2 dados de dano e espalha Infecção para até 2 inimigos próximos | **Teratogênese**<br>*Ação – 1 vez por cena*<br>O contratante libera as mutações acumuladas em um surto grotesco de vida degenerada.<br><br>Ao utilizar cargas de *Corrupção biológica* pode aplicar [[Infectado\|Infecçao]] em mais uma criatura ou causar 1d6 de dano em uma criatura infectada<br><br>Uma vez por turno, quando inimigos afetados por infecções morrem, recupera uma carga de *Corrupção biológica* e recupera PV igual o nível de infecção<br>3PV para infecção<br>6PV para infecção severa |
...
| **Nivel 1  <br>**                                                           | **Nivel 2  <br>**                                                                                      | **Nivel 3<br>**                                                                                                                                                                                                                                                                 |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Magias:**  <br>[[Arma encantada]]<br>[[Duelo Compelido]]                  | **Domínio de Batalha**  <br>Inimigos engajados com você recebem -2 em testes para atacar outros alvos. | **General Arcano**  <br>_Ação – 1 vez por cena_<br><br>Por 3 turnos:<br><br>- Aliados recebem +2 ataque<br>- Aliados recebem +2 Defesa<br>- Transforma ambas as reações em uma ação para um aliado. Esse aliado e escolhido deve ser escolhido na utilização da característica. |
