Uma cena de combate e organizada em turnos de personagens, e cada turno organizado em ações.
Normalmente, cada personagem pode realizar três ações por turno.
...
### Bloquear
Ao ser alvo de um ataque físico o bloqueia, aumentando sua defesa em +2 para o próximo ataque. Bloquear custa duas reações.
